    ...
    void historyd(){
        ...
        try{
            ...
            Connection con=DriverManager.getConnection(url,user,password);
                ...
                String er = "select journey_date,journey_time,booking_sit,distance,customer_name,customer_phone,customer_mail,issue_date from booking_history where session like '%"+sessionCode+"%'";
